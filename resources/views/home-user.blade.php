...
<body>
        ...
        <div class="mycontainer">
            ...
            <div class="navbar">
                ...
                <div class="cart">
                    ...
                    <a href="/cartU">Cart( {{ Session::has('cart') ? Session::get('cart')->totalQty : ''}} )</a>
                </div>
                <div class="account">
    ...
    <div class="small-container-category">
        ...
        <nav class="">
            <ul>
                ...
                <li><a href="/categoryUser/{{$category->id}}">{{$category->name}}</a></li>
                @endforeach
            </ul>
        </nav>
    </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4 my-col-4">
                <div class="card h-100">
                    <a href="/productDetailU/{{$product->id}}"><img class="card-img-top" src="/images/{{$product->image}}" alt="" width="300px" height="300px" /></a>
                    <div class="card-body">

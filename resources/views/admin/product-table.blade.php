        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <a href="/add-product" class="btn btn-primary btn-new" role="button" aria-pressed="true">New Product</a>
                    <br>
                    <div class="card mb-4">
                        ...
                        <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0" action="/search" method="get">
                            <div class="input-group">
                                <input class="form-control" type="text" name="query" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2"/>
                                <div class="input-group-append">
